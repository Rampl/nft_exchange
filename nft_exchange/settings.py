"""
Django settings for nft_exchange project.
...
SECRET_KEY = '06gk@u@&)6^tm1@kaxnnrk98ir$)z80s^_5^bcp+isd1j$ci7j'
...
ROOT_URLCONF = 'nft_exchange.urls'
...
WSGI_APPLICATION = 'nft_exchange.wsgi.application'
